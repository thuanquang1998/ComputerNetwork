...
public class SharedFile  extends Thread {
	...
	public void run() {
		...
		try{
			...
			while(true)
			{
					//Lấy thông điêp Client
					String message = input.readUTF();
					// Lấy ra đối tượng Document
				...
				if(doc.getDocumentElement().getNodeName().equals("FILE_REQ")) {
                	...
                	//Đối phương chấp nhận yêu cầu,,thực hiện gửi file.
                	sendfile(filepath);
                	...
                	//Đối phương từ chối yêu cầu nên không gửi file
